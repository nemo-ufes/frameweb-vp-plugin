...
public class ${class.name} <@generalization.generate_generalization generalization=class.generalization defaultGeneralization=''/> <@realizations.generate_realization realizations=class.realizations defaultRealization=''/> {
/** Serialization id. */

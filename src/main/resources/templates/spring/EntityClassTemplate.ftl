...
@Entity
<@generalization_stereotype.generate_generalization_stereotype stereotype=clazz.inheritanceStereotype/>
public class ${clazz.name} <@generalization.generate_generalization generalization=clazz.generalization defaultGeneralization=''/> <@realizations.generate_realization realizations=clazz.realizations defaultRealization=''/> {
/** Serialization id. */

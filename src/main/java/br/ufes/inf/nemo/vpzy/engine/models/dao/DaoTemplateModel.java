...
/**
 * Holds the model for the persistent templates.
 *
 * @author Igor Sunderhus e Silva
 * @version 0.0.1
 */
public class DaoTemplateModel extends AbstractTemplateModel {
    /**
     ...
     */
    public DaoTemplateModel(final IModelElement pack, final AbstractClassModel clazz, final String path,
